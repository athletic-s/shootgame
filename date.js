...
let tekiMaster=[new TekiMaster(0,10,1,100),//0,ピンクひよこ
    new TekiMaster(1,10,1,100),//1,黄色ひよこ
	new TekiMaster(2,70,3000,10000),//2,ボスひよこ黄色
	new TekiMaster(3,10,1,10),//3,ボスひよこ黄色のこども
]
//スプライトクラス
class Sprite {
    constructor(x, y, w, h) {
...
let sprite = [
    ...
    new Sprite(23, 0, 33, 42),//１，自機　左１
    new Sprite(57, 0, 43, 42),//２，自機　正面
    new Sprite(101, 0, 33, 42),//３，自機　右１
    new Sprite(135, 0, 21, 42),//４，自機　右２
